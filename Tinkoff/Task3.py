...
floors = [int(elem) for elem in input().split()]
t_employee = int(input())
if floors[t_employee - 1] < t:
    print(floors[-1] - floors[0])
else:
    print(min(floors[-1] - floors[0] + floors[-1] - floors[t_employee - 1],
              floors[-1] - floors[0] - floors[0] + floors[t_employee - 1]))
